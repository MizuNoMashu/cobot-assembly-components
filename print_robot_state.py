...
def main():
    ...
    try:
        ...
        print("Hint: pylibfranka needs realtime scheduling privileges.")
        print(" - Option 1: run as root/sudo: sudo ./.venv/bin/python print_robot_state.py --ip <ip>")
        print(" - Option 2: grant capability to the Python binary:")
        print("     sudo setcap cap_sys_nice+ep $(readlink -f ./.venv/bin/python)")
        print("Then re-run without sudo if you prefer.")
        return
